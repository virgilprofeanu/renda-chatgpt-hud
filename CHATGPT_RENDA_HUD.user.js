...
// @version      4.9.14
// v4.9.14 (2026-07-14): catalog PLUGINS FINAL — 139 intrari (25 noi fata de 4.9.12, intre care
...
(() => {
  ...
  function buildAgentsPanel(hud) {
    ...
    panel.innerHTML = '<button class="ag-close" type="button" aria-label="Închide">✕</button>'
      ...
      + '<button class="ag-tab" data-tab="skills" type="button">Skills &amp; Plugins (' + (nS + nP) + ')</button>'
      + '</div>'
